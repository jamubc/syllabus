        ...
        <div className="container relative mx-auto px-4">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground sm:text-xl">
              From course management to AI assistance, discover how Canvas MCP Tool transforms your academic workflow with powerful, integrated features.
            </p>
          ...
          >
            ...
            <div className="relative mx-auto max-w-2xl">
              ...
              <p className="mt-4 text-lg text-primary-foreground/90">
                Join thousands using Canvas MCP Tool to transform their academic experience
              </p>
